...
export function PixelBackground({
  ...
  return (
    <div className={`fixed inset-0 z-0 pointer-events-none overflow-hidden bg-[#020617] ${className}`}>
      <PixelCanvas colors={colors} gap={gap} speed={speed} />
...
/**
 * GlobalBackground automatically applies the PixelCanvas and radial gradient
 * background across all pages and components, while ignoring all blog routes.
 */
export default function GlobalBackground() {
  const pathname = usePathname();
  const isBlog = pathname ? pathname.includes("/blog") : false;

...
export function Marquee({
  ...
  return (
    <div
      ...
      data-slot="marquee"
      className={cn(
        'group flex overflow-hidden p-2 [--duration:40s] [--gap:1.25rem] [gap:var(--gap)] select-none [contain:paint_layout]',
        {
          'flex-row': !vertical,
          'flex-col': vertical,
        },
            ...
            {Array.from({ length: repeat }, (_, i) => (
              <div
                ...
                className={cn(
                  ...
                  'flex shrink-0 justify-around will-change-transform transform-gpu',
